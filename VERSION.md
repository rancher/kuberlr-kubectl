...
|---------------------|---------------|------------------------|
| main (release/v9.x) | head (v9.Y.Z) | 2.16.Z (main)          |
| release/v8.x        | v8.Y.Z        | 2.15.Z (release/v2.15) |
| release/v7.x        | v7.Y.Z        | 2.14.Z (release/v2.14) |
...
|-----------------|---------|---------|-------------------------|
| 2.16.x          | 1.35    | 1.37    | 9.y.z                   |
| 2.15.x          | 1.34    | 1.36    | 8.y.z                   |
